...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="http://packhacks2021.srinath.tech/transactions" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  Transactions</a>
            <a href="http://packhacks2021.srinath.tech/subscriptions" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  Subscriptions</a>
